		...
		'Img' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('Images','easy-fancybox')
					),
				'intro' => array (
						'hide' => true,
						'description' => __('The settings listed below determine the image overlay behaviour controlled by FancyBox.','easy-fancybox') . '<br />'
					),
				'autoAttribute' => array (
...
/* TODO  : only use this parm when 'titlePosition' : 'over'
				...
				'outro' => array (
						'hide' => true,
						'description' => '<br /><br />' . __('* Easing effects only apply when Transition is set to Elastic.','easy-fancybox')
					)
				)
			),
		...
		'PDF' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('PDF','easy-fancybox')
					),
				'autoAttribute' => array (
				...
				'intro' => array (
						'hide' => true,
						'description' => __('To make any PDF document file open in an overlay, auto-enable it or use the tag class="fancybox-pdf" for its link.','easy-fancybox') . ' ' . __('The overlay will use the dimensions set here. These can be relative (using %) or absolute sizes.','easy-fancybox') . '<br /><br />'
					),
				'type' => array (
						'default' => 'html'
					),
		...
		'SWF' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('SWF','easy-fancybox')
					),
				'autoAttribute' => array (
				...
				'intro' => array (
						'hide' => true,
						'description' => __('These settings determine the SWF overlay behaviour controlled by FancyBox.','easy-fancybox') . ' ' . __('To make any Flash (.swf) file open in an overlay, auto-enable it or use the tag class="fancybox-swf" for its page link.','easy-fancybox') . ' ' . __('The overlay will use the dimensions set here. These can be relative (using %) or absolute sizes.','easy-fancybox') . '<br /><br />'
					),
				'type' => array( 
						'default' => 'swf' 
					),
		...
		'YouTube' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('YouTube','easy-fancybox')
					),
				'autoAttribute' => array (
				...
				'intro' => array (
						'hide' => true,
						'description' => __('To make any YouTube movie open in an overlay, auto-enable it or use the tag class="fancybox-youtube" for its page link.','easy-fancybox') . ' ' . __('The overlay will use the dimensions set here. These can be relative (using %) or absolute sizes.','easy-fancybox') . '<br /><br />'
					),
				'type' => array( 
						'default' => 'swf' 
					),
		...
		'Vimeo' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('Vimeo','easy-fancybox')
					),
				'autoAttribute' => array (
				...
				'intro' => array (
						'hide' => true,
						'description' => __('To make any Vimeo movie open in an overlay, auto-enable it or use the tag class="fancybox-vimeo" for its page link.','easy-fancybox') . ' ' . __('The overlay will use the dimensions set here. These can be relative (using %) or absolute sizes.','easy-fancybox') . '<br /><br />'
					),
				'type' => array( 
						'default' => 'swf' 
					),
		...
		'iFrame' => array(
			...
			'options' => array(
				'enable' => array (
						...
						'hide' => true,
						'default' => '',
						'description' => __('Enable FancyBox for','easy-fancybox') . ' ' . __('iFrames','easy-fancybox')
					),
				'class' => array (
						'hide' => true,
				...
				'intro' => array (
						'hide' => true,
						'description' => __('To make a website or HTML document open in an overlay, use the tag class="fancybox-iframe" for its link.','easy-fancybox') . ' ' . __('The overlay will use the dimensions set here. These can be relative (using %) or absolute sizes.','easy-fancybox') . '<br /><br />'
					),
				'type' => array (
						'default' => 'html'
					),
...
jQuery(document).ready(function($){";
	...
	foreach ($easy_fancybox_array as $key => $value) {
		// check if not enabled then skip
		if (!get_option($value['options']['enable']['id'], $value['options']['enable']['default']))
			continue;
	...
	fb_".$key."_posts.each(function() {
		jQuery(this).find(fb_imglinks).addClass('".$value['options']['class']['default']."').attr('rel', 'gallery-' + fb_posts.index(this));
	});";
				}
			}
		}
	...
	$('a[".$value['options']['autoAttributeAlt']['selector']."]')";
		...
		$more=0;
		echo '
	$(\'a.'.$value['options']['class']['default'].'\').fancybox({';
