			...
			'Enable' => array(
				...
				'options' => array(
					...
					'Inline' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'Inline content', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableInline' ) ? ' &mdash; <a href="#Inline">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'PDF' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'PDF', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enablePDF' ) ? ' &mdash; <a href="#PDF">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'SVG' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'SVG', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableSVG' ) ? ' &mdash; <a href="#SVG">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'VideoPress' => array(
						'id' => '',
						'input' => 'checkbox',
					...
					'YouTube' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'YouTube', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableYouTube' ) ? ' &mdash; <a href="#YouTube">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'Vimeo' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'Vimeo', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableVimeo' ) ? ' &mdash; <a href="#Vimeo">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'Dailymotion' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'Dailymotion', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableDailymotion' ) ? ' &mdash; <a href="#Dailymotion">' . translate( 'Settings' ) . '</a>' : '' ),
					),
					'Instagram' => array(
					...
					'iFrame' => array(
						...
						'hide' => true,
						'default' => '',
						'description' => '<strong>' . esc_html__( 'iFrames', 'easy-fancybox' ) . '</strong>' . ( get_option( 'fancybox_enableiFrame' ) ? ' &mdash; <a href="#iFrame">' . translate( 'Settings' ) . '</a>' : '' ),
					),
				),
				'description' => '',
			),
